...
#include <sstream>
#include <string>
#include "D:\Program Files (x86)\My projects\C++\BigInt\BigInt.h"
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(138, 96);
			...
			// textBox2
			// 
			this->textBox2->Location = System::Drawing::Point(138, 167);
			...
			this->label3->Location = System::Drawing::Point(90, 359);
			...
			this->button1->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->button1->Location = System::Drawing::Point(60, 258);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(117, 55);
			...
			this->button2->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->button2->Location = System::Drawing::Point(215, 258);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(117, 55);
			...
			this->label5->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 20, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label5->Location = System::Drawing::Point(89, 27);
			this->label5->Name = L"label5";
			this->label5->Size = System::Drawing::Size(182, 39);
			this->label5->TabIndex = 8;
			this->label5->Text = L"Big Integer";
			// 
			// MyForm
			// 
			this->AutoScaleDimensions = System::Drawing::SizeF(8, 16);
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->ClientSize = System::Drawing::Size(400, 427);
...
{
	chars = (const char*)(Marshal::StringToHGlobalAnsi(textBox1->Text)).ToPointer();
	s1 = chars;
	chars = (const char*)(Marshal::StringToHGlobalAnsi(textBox2->Text)).ToPointer();
	s2 = chars;
	...
	bridge << num1 + num2;
	os = bridge.str();
	String^ sysos = gcnew String(os.c_str());
	label3->Text = sysos;
}
